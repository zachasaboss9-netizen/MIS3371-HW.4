...
inputs.forEach(function (input) {
    ...
    // Set a cookie when the input field changes (only if Remember Me is checked)
...
// On page load, check if there are existing cookies and show welcome message
document.addEventListener("DOMContentLoaded", function () {
    // Check if Remember Me should be checked based on existing cookies
    const hasCookies = inputs.some(input => getCookie(input.cookieName) !== "");
    if (hasCookies) {
        document.getElementById("remember-me").checked = true;
    }

    // Greet the user if their first name cookie is set and provide an option to start a new form if it's not them
    ...
    if (firstName !== "") {
        ...
        document.getElementById("welcome1").innerHTML = "Welcome new patient!<br>";
        document.getElementById("welcome2").innerHTML = "Please fill out the registration form below.";
    }
    ...
    document.getElementById("remember-me").addEventListener("change", function () {
        if (!this.checked) {
            ...
            // Hide welcome message and show new patient message
            document.getElementById("welcome1").innerHTML = "Welcome new patient!<br>";
            document.getElementById("welcome2").innerHTML = "Please fill out the registration form below.";
        }
    });
